...
export class ReportsController {
  ...
  @Get('mensagens-por-usuario')
  @Roles('admin', 'supervisor', 'digital')
  async getMensagensPorUsuarioReport(@Query() filters: ReportFilterDto, @CurrentUser() user: any) {
    return this.reportsService.getMensagensPorUsuarioReport(this.applySegmentFilter(filters, user), user.identifier);
  }

  @Get('linhas-banidas-por-usuario')
  @Roles('admin', 'supervisor', 'digital')
  async getLinhasBanidasPorUsuarioReport(@Query() filters: ReportFilterDto, @CurrentUser() user: any) {
    return this.reportsService.getLinhasBanidasPorUsuarioReport(this.applySegmentFilter(filters, user), user.identifier);
  }
  ...
  @Get('auditoria-linhas')
  @Roles('admin', 'supervisor')
  async getAuditoriaLinhasReport(@Query() filters: ReportFilterDto) {
    return this.reportsService.getAuditoriaLinhasReport(filters);
  }
  ...
  async getConsolidatedReport(@Query() filters: ReportFilterDto, @CurrentUser() user: any) {
    ...
    const [
      ...
      this.reportsService.getAuditoriaLinhasReport(filteredFilters),
    ]);
