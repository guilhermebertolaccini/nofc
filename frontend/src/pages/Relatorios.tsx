...
const reportTypes: ReportType[] = [
  ...
  { value: "envios", label: "Envios", digitalExcluded: true },
  ...
  {
    value: "dados_transacionados",
    label: "Dados Transacionados",
    digitalExcluded: true,
  },
  { value: "detalhado_conversas", label: "Envios" },
  { value: "linhas", label: "Linhas", digitalExcluded: true },
  {
    value: "mensagens_por_linha",
    label: "Mensagens por Linha",
    digitalExcluded: true,
  },
  { value: "mensagens_operador", label: "Mensagens por Operador" },
  { value: "mensagens_por_usuario", label: "Mensagens por Usuário", adminOnly: true },
  { value: "linhas_banidas_por_usuario", label: "Bans por Usuário", adminOnly: true },
  ...
  {
    value: "auditoria_linhas",
    label: "Auditoria Transferência de Linhas",
    adminOnly: true,
  },
];
